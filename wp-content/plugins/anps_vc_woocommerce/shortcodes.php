...
function product_attribute_settings_field($settings, $value) {   
    $categories = wc_get_attribute_taxonomies();
    $dependency = vc_generate_dependencies_attributes($settings);
    $data = '<select name="'.$settings['param_name'].'" class="wpb_vc_param_value wpb-input wpb-select '.$settings['param_name'].' '.$settings['type'].'">';
   ...
   "params" => array(
      ...
      array(
       ...
       array(
         ...
         "param_name" => "orderby",
         "value" => array(__("Date", ANPS_PLUGIN_LANG)=>'date', __("None", ANPS_PLUGIN_LANG)=>'none', __("ID", ANPS_PLUGIN_LANG)=>'ID', __("Title", ANPS_PLUGIN_LANG)=>'title', __("Name", ANPS_PLUGIN_LANG)=>'name', __("Modified", ANPS_PLUGIN_LANG)=>'modified', __("Random", ANPS_PLUGIN_LANG)=>'rand', __("Menu order", ANPS_PLUGIN_LANG)=>'menu_order')  
       ),
       array(
         "type" => "dropdown",
         "holder" => "div",
...
vc_map( array(
   ...
   "params" => array(
       ...
       array(
         ...
         "heading" => __("Order by", ANPS_PLUGIN_LANG),
         "param_name" => "orderby",
         "value" => array(__("Title", ANPS_PLUGIN_LANG)=>'title', __("None", ANPS_PLUGIN_LANG)=>'none', __("ID", ANPS_PLUGIN_LANG)=>'ID', __("Date", ANPS_PLUGIN_LANG)=>'date', __("Name", ANPS_PLUGIN_LANG)=>'name', __("Modified", ANPS_PLUGIN_LANG)=>'modified', __("Random", ANPS_PLUGIN_LANG)=>'rand', __("Menu order", ANPS_PLUGIN_LANG)=>'menu_order')  
       ),
       array(
         "type" => "dropdown",
         "holder" => "div",
   ...
   "params" => array(
      ...
      array(
       ...
       array(
         ...
         "heading" => __("Order by", ANPS_PLUGIN_LANG),
         "param_name" => "orderby",
         "value" => array(__("Name", ANPS_PLUGIN_LANG)=>'name', __("None", ANPS_PLUGIN_LANG)=>'none', __("ID", ANPS_PLUGIN_LANG)=>'ID', __("Date", ANPS_PLUGIN_LANG)=>'date', __("Title", ANPS_PLUGIN_LANG)=>'title', __("Modified", ANPS_PLUGIN_LANG)=>'modified', __("Random", ANPS_PLUGIN_LANG)=>'rand', __("Menu order", ANPS_PLUGIN_LANG)=>'menu_order')  
       ),
       array(
         "type" => "dropdown",
         "holder" => "div",
