/*!
 * Screets Chat X - Plugin options scripts
 * Author: @screetscom
 *
...
(function ($) {
	$(document).ready(function () {
				...
				switch( opt_id ){
					...
					case 'app-bucket':
						...
						if( opt_v.indexOf( _s ) > -1 || opt_v.indexOf( _s ) > -1 ) {
							...
							err = true;
							$( '#screets-cx_' + opt_id ).parent().append( '<p class="scx-red"><span class="dashicons dashicons-warning"></span>  Copy/paste the whole snippet</p>' );
						}*/
		...
		var $appDB = document.getElementById('screets-cx_app-db');
		if( $appDB ) {
