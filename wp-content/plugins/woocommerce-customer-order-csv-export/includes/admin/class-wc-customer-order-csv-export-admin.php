		...
		$settings = array(
			...
			'export' => array(
				...
				array(
					...
					'name'    => __( 'Export Orders or Customers-http://goo.gl/EZNSSi', WC_Customer_Order_CSV_Export::TEXT_DOMAIN ),
					'type'    => 'radio',
					'options' => array(
				...
				array(
					...
					'name' => __( 'End Date-http://goo.gl/EZNSSi', WC_Customer_Order_CSV_Export::TEXT_DOMAIN ),
