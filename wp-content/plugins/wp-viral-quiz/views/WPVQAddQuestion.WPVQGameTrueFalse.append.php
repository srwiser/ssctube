...
<div>
	<div class="vq-bloc wpvq-uniq-question" data-questionIndex="">
		...
		<h3><?php _e('Question', '', 'wpvq'); ?> #<span class="vq-questionNum">%%questionIndex%%</span> : <input type="text" name="£questionLabel£" class="vq-question-label" placeholder="<?php _e('Is it ..... ?', '', 'wpvq'); ?>" value="%%questionLabel%%"/></h3>
