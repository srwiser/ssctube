            ...
            <nav id="navigation" itemtype="http://schema.org/SiteNavigationElement" itemscope="itemscope" role="navigation" class="<?php echo $dd_effect.$nav_sh; ?> ">
                ...
                <div class="inner">
                    ...
                    <?php if ( has_nav_menu( 'main' ) ) { ?>
                        <?php 
$main_menu_query = get_transient( 'main_menu_query'.get_queried_object_id() );
if( $main_menu_query === false ) {
    $main_menu_query = wp_nav_menu ( array( 'menu_class' => 'main-menu mom_visibility_desktop','container'=> 'ul', 'theme_location' => 'main', 'walker' => new mom_custom_Walker(), 'echo' => false  )); 
        set_transient( 'main_menu_query'.get_queried_object_id(), $main_menu_query, 60*60*24 );
}
echo $main_menu_query;
    ?>
                    ...
                    <?php if ( has_nav_menu( 'main' ) ) { ?>
                        ...
                        <?php 
$main_mobile_menu_query = get_transient( 'main_mobile_menu_query'.get_queried_object_id() );
if( $main_mobile_menu_query === false ) {
    $main_mobile_menu_query = wp_nav_menu ( array( 'menu_class' => 'device-menu mom_visibility_device','container'=> 'ul', 'theme_location' => 'main', 'walker' => new mom_mobile_custom_walker(), 'echo' => false  )); 
        set_transient( 'main_mobile_menu_query'.get_queried_object_id(), $main_mobile_menu_query, 60*60*24 );
}
