					...
					if ($html5_poster == '') {
						$html5_poster = ' poster="'.get_post_meta($post->ID, 'mom_video_html_poster', true).'" ';
                                    ...
                                    <div class="video_frame">
                                      <iframe width="<?php echo $vi_width; ?>" height="<?php echo $vi_height; ?>" src="http://www.youtube.com/embed/<?php echo $video_id; ?>?<?php echo $e_autoplay; ?>" frameborder="0" allowfullscreen></iframe>
                                    </div><!--End Vido_frame-->
