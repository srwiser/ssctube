...
if (in_array('both-sidebars',$classes)) {
	...
	<div class="fslides fs-<?php echo $rndn; ?>">
		...
		?>
                        <div <?php post_class('fslide'); ?> itemscope itemtype="http://schema.org/Article" data-i="<?php echo $i; ?>">
...
'ignore_sticky_posts' => 1,
		...
		<?php if (mom_post_image() != false) { if ($unique_posts) {$do_unique_posts[] = get_the_ID();} ?>
                       <div class="fs-thumb" <?php post_class(); ?> itemscope itemtype="http://schema.org/Article" data-i="<?php echo $i; ?>">
