...
<!--[if gt IE 8]><!--> <html class="no-js" <?php language_attributes(); ?>> <!--<![endif]-->
    <head>
	<!-- PopAds.net Popunder Code for www.ssctube.com -->
<script type="text/javascript">
  var _pop = _pop || [];
  _pop.push(['siteId', 762062]);
...
<!-- PopAds.net Popunder Code End -->
	<meta name="google-site-verification" content="jf1T1pQYqSwexDxNyjweGZHCz5Qt7BChYzDIG3yJspM" />
